{{-- Stary navbar bez uzycia "php artisanmake:auth" --}}

{{-- <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="/">{{config('app.name', 'test3')}}</a>
    ...
    <div class="nav navbar-nav navbar-right"><a class="nav-item nav-link" href="/posts/create">Create Post</a>
  </nav> --}}
